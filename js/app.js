...
for (var i=0;i<syatelCokie.hours.length;i++){
  ...
  var totalCo = randomNum*syatelCokie.averageCo;
...
for (var j=0;j<tokyoCokie.hours.length;j++){
  ...
  var totalCo1 = randomNum1*tokyoCokie.averageCo;
...
for (var k=0;k<dubaiCokie.hours.length;k++){
  ...
  var totalCo2 = randomNum2*dubaiCokie.averageCo;
...
for (var g=0;g<parisCokie.hours.length;g++){
  ...
  var totalCo3 = randomNum3*parisCokie.averageCo;
...
for (var f=0;f<limaCokie.hours.length;f++){
  ...
  var totalCo4 = randomNum4*limaCokie.averageCo;
